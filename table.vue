            ...
            <el-tabs v-model="activeName2" type="card" @tab-click="handleClick">
              <el-tab-pane label="Tonnage Cards" name="first">
                ...
                <div>
                  ...
                  <!--Sent within 框的实现-->
                  <div id=sentWithin1 style="text-align:left;display:inline ">
                    &nbsp;&nbsp;Sent within : &nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;
                ...
                <div>
                  ...
                  <!--Built 框的实现-->
                  <div id=built1 style="text-align:left ;display:inline ;float:left">
                    Built :
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Under
...
export default {
  ...
  methods: {
    ...
    searchCargo1() {
      ...
      //   "opendate_start": this.datepickerList[0],
      //   "opendate_end": this.datepickerList[1],
        "days": 1,
        "built": 100,
        "account": "",
        "dwt": dwt1
    ...
    searchCargo2() {
      ...
      var conditions = {
        ...
        // "laycan_start": this.datepickerList[0],
        // "laycan_end": this.datepickerList[1],
        "days": 1,
        "quantity": Quantity1,
        "account": ""
